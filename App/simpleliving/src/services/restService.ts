...
export class RestService {
   ...
   public getHouse(houseId: number): Promise<any> {
        return this.http.get(this.requestUrl+"house/"+houseId)
        .map(response => {
               return response.json() || { success: false, message: "No response from server" };
           }).catch((error: Response | any) => {
               return Observable.throw(error.json());
    ...
    public updateListItemQuantity(item: any): Promise<any> {
        let headers = new Headers();
         headers.append("Content-Type","application/json");
         let body = {
           item: item
	...
	public deleteListItem(item: any): Promise<any> {
		return this.http.delete(this.requestUrl+"items/"+item.ItemId)
         .map(response => {
          return response.json() || {success: false, message: "No response from server"};
        }).catch((error: Response | any) => {
          return Observable.throw(error.json());
    ...
    public updateSSQuantity(): Promise<any> {
